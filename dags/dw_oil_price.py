...
with DAG('dw_oil_price', schedule_interval="@once", default_args=default_args,tags=['Data Warehouse'], catchup=False) as dag:
    ...
    def get_data(**kwargs):
        ...
        for round in range(5):
            ...
            for month in range(1,now.month+1):
                ...
                payload = {"provinceId":1,"districtId":None,"year":now.year-round,"month":month,"pageSize":1000000,"pageIndex":0}
